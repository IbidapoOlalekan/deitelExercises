...
public class ChristmasQuestion {
    ...
    public ChristmasQuestion(String question) {
        this.question = question;
        String[] questions =  displayQuestions();
        Random randomGenerator = new Random();
        int index = randomGenerator.nextInt(displayQuestions().length);
        ChristmasQuestion.displayQuestions();
    }
